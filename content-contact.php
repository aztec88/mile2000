			...
			<div class="container">
				...
				<div class="row">
					...
					if ( $is_shotcode ) {
						...
						echo '<div class="col-xs-12  ' . ( $is_content ? 'col-sm-12' : 'col-sm-12' ) . ' contact-page-form">';
					...
					if ( $is_content ) {
						...
						echo '<div class="col-xs-12 ' . ( $is_shotcode ? 'col-sm-12' : 'col-sm-12' ) . ' contact-page-content">';
